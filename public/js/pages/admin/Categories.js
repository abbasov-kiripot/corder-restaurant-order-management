...
export default class Categories {
  ...
  async categoryRegister() {
    ...
    if (categoryImageFile == null) {
      alert("Zəhmət olmasa kateqoriya şəklini seçin.");
  ...
  updateProductFile() {
    ...
    document
      ...
      .addEventListener("change", async () => {
        ...
        if ((response.status_code = "success")) {
          alert("Kateqoriya şəkli uğurla yeniləndi.");
          ...
          alert("Kateqoriya şəklini yeniləyərkən xəta baş verdi!");
        }
      });
  }
}
