...
export default class Products {
  ...
  async categoryRegister() {
    ...
    if (productName == "") {
      alert("Zəhmət olmasa məhsulun adını daxil edin.");

      return;
    }

    if (productPrice == "") {
      alert("Zəhmət olmasa məhsulun qiymətini daxil edin.");
    ...
    if (productImageFile == null) {
      alert("Zəhmət olmasa məhsulun şəklini seçin.");
  ...
  updateProductFile() {
    ...
    document
      ...
      .addEventListener("change", async () => {
        ...
        if ((response.status_code = "success")) {
          alert("Məhsul şəkli uğurla yeniləndi.");
          ...
          alert("Məhsulun şəklini yeniləyərkən xəta baş verdi!");
        }
      });
  }
}
