...
<body tabindex="0">
    ...
    <div class="header">
        ...
        <div style="position: absolute;right:15px;font-size:38px;"><a style="color:#e0a82f;" target="_blank" href="https://www.instagram.com/23.abasovs/"><i class="fa-brands fa-instagram"></i></a></div>

    </div>

    <!-- header end -->

    <div class="catchword">Kategoriyalar</div>
    ...
    <div class="popup" id="popup">
        ...
        <div class="popup-content">
            ...
            <div class="subtotal">
                ...
                <p class="subtotal-header">Ümumi:</p>

                <p class="subtotal-value"><span class="tl"> AZN</span></p>

            </div>

            <div class="controls">

                <button class="close-btn">Menüya Dön</button>

                <button class="submit-btn">Sifarişi Tamamla</button>
...
<!-- card modal end -->
    ...
    <body>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <div>
                    ...
                    <p>4 Butulka Efes Səməni + Kartof Fri Cəmi  ₼500</p>
         ...
         // document.querySelector("#basket").addEventListener("click", popup);
            ...
            <div class="product-item">
              ...
              <div class="product-info">
                ...
                <p class="product-price">${moneyFormatter(element.product_price, "AZN")}</p>
        ...
        `;
                ...
                cartTotal.innerHTML = `${moneyFormatter(totalPrice, "AZN")}`;
