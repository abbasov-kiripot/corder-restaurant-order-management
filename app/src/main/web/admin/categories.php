...
<input class="category-name-input" placeholder="Kateqoriya Adı" type="text">

<div class="category-file">

    <button type="button" class="category-file-button">

        <span><i class="fa-solid fa-upload"></i>&nbsp;&nbsp;&nbsp;Kateqoriya Fotosu</span>
...
<button class="register-button">Qeyd Et</button>
...
<div class="table-section">
    ...
    <table>
        ...
        <thead>
            ...
            <tr>
                ...
                <th>Kateqoriya Şəkli</th>

                <th>Kateqoriya Statusu</th>
    ...
    <div class="modal-header">
        ...
        <h2>Kateqoriya Yeniləmə Formu</h2>
    ...
    <div class="modal-body">
        ...
        <div>
            ...
            <label for="modal-category-name">Kateqoriya Adı</label>
        ...
        <div>
            ...
            <button class="modal-update-button">Yenilə</button>
