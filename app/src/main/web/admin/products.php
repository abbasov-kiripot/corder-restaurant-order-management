        ...
        <div class="content-wrapper">
            ...
            <div class="left">
                ...
                <select id="selected-category">
                    ...
                    <option selected value="0">Məhsul yeniləmə forumu</option>
                ...
                <div class="file-select-button-wrapper">
                    ...
                    <button type="button" class="file-select-button">
                        ...
                        <span><i class="fa-solid fa-upload"></i>&nbsp;&nbsp;&nbsp;Məhsul şəkili</span>
                ...
                <button class="register-button">Yüklə</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <label for="modal-product-name">Məhsul Adı</label>
                ...
                <div>
                    ...
                    <label for="modal-product-price">Məhsul Qiyməti</label>
                ...
                <div>
                    ...
                    <button class="modal-update-button">Güncəllə</button>
