...
<head>
    ...
    <title>Compart Order - Əl Terminalı</title>
...
<body tabindex="0">
    ...
    <div class="login-screen" id="login-screen">
        ...
        <form>
            ...
            <button id="systemUserLoginButton" type="button">Giriş Et</button>

        </form>

        <a href="tel:+994778848515"><i class="fa-solid fa-phone"></i> Müştəri xidməti</a>
