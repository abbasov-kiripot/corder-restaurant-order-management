...
<body tabindex="0">
    ...
    <div class="table-operations-screen" id="table-operations-screen">
        ...
        <div class="table-meta-data">
            ...
            <p>
                ...
                <span id="selected-table-number-of-tickets">## Xidmət</span>
    ...
    <button id="newOrderButton"><i class="fa-solid fa-circle-plus"></i>Yeni Sifariş</button>

    <button id="moving-table-button"><i class="fa-solid fa-share"></i>Masanı Dəyiş</button>

    <button id="closeTableButton"><i class="fa-solid fa-circle-xmark"></i>Masanı Bağla</button>

    <button id="print-receipt"><i class="fa-solid fa-print"></i>Çap Et</button>
        ...
        <div id="moving-table-wrapper" class="modal">
            ...
            <div class="modal-content">
                ...
                <div>
                    ...
                    <p class="moving-table-question">Masanı Hara Daşıyaq?</p>
                    ...
                    <div class="tables-wrapper">
                        ...
                        <select name="" id="table-numbers">
                            ...
                            <option selected value="string">Masa Nömrəsi</option>
                    ...
                    <button class="moving-table-register-button">Dəyiş</button>

                    <div class="moving-table-warning">

                        <p><i class="fa-solid fa-circle-info"></i>Əgər köçürdüyünüz masanın aktiv bileti varsa, cədvəl avtomatik olaraq birləşdiriləcək..</p>
        ...
        <a id="return-table-button"><i class="fa-solid fa-arrow-left"></i>Masalara Qayıt</a>
